    ...
    fluidPage(
        tabsetPanel(id  = "VDJ",
            ...
            tabPanel("Transcriptomics",
                ...
                fluidRow(
                    column(6, plotOutput("transcriptomics.featureplot") %>% withSpinner()),
                    column(6, plotOutput("transcriptomics.clonotype.featureplot") %>% withSpinner())
                )
            ),
            tabPanel("DEG",
                tabsetPanel(
                    tabPanel("Select groups",
                        div(class = "d-flex justify-content-around",
                            div(class = "col-sm-5 well",
                                h4("Specify group 1"),
                                fluidRow(
                                    column(6, sliderInput("sig.P", "significant P-value", 0.01, 0.1, 0.05)),
                                    column(6, sliderInput("sig.logFC", "significant Log2 fold change", 0, 5, 0.6, step = 0.01))
                                ),
                                fluidRow(
